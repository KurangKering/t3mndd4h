...
<section class="section">
									...
									<div class="card-body">
										<div class="form-group">
											...
											<div class="custom-switches-stacked mt-2">
												...
												<label class="custom-switch">
													<input type="radio" name="status" value="{{ $k }}" class="custom-switch-input">
													<span class="custom-switch-indicator"></span>
													<span class="custom-switch-description">{{ $v }}</span>
												</label>
									...
									<div class="card-body">
										<div class="form-group">
											...
											<div class="custom-switches-stacked mt-2">
												...
												<label class="custom-switch">
													<input type="radio" name="top" value="{{ $k }}" class="custom-switch-input">
													<span class="custom-switch-indicator"></span>
													<span class="custom-switch-description">{{ $v }}</span>
												</label>
									...
									<div class="card-body">
										<div class="form-group">
											...
											<div class="custom-switches-stacked mt-2">
												...
												@foreach (hJK() as $k => $v) 
												<label class="custom-switch">
													<input type="radio" name="jk" value="{{ $k }}" class="custom-switch-input">
													<span class="custom-switch-indicator"></span>
													<span class="custom-switch-description">{{ $v }}</span>
												</label>
									...
									<div class="card-body">
										<div class="form-group">
											...
											<div class="custom-switches-stacked mt-2">
												...
												<label class="custom-switch">
													<input type="radio" name="usia" value="{{ $k }}" class="custom-switch-input">
													<span class="custom-switch-indicator"></span>
													<span class="custom-switch-description">{{ $v }}</span>
												</label>
	...
	<script>
		...
		async function fetchData(values) {
			var url = "{{ base_url('testtesttreemap/map?') }}"+values;
